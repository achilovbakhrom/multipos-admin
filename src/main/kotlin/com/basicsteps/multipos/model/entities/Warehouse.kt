...
@Entity
data class Warehouse(@SerializedName("name") var name: String,
...
data class StockResponse(@SerializedName("warehouse") var warehouse: Warehouse, @SerializedName("pos_ids") var posIds: List<String>)