...
class DbManager(vertx: Vertx) {
    ...
    var productStateDao: ProductStateDao? = null
    var warehouseQueueDao: WarehouseQueueDao? = null
    var productCostDao: ProductCostDao? = null
    var inventoryDao: InventoryDao? = null
    var paymentDao: PaymentDao? = null
    var returnFromCustomerDao: ReturnFromCustomerDao? = null
    ...
    init {
        ...
        productStateDao                 = ProductStateDao(this, null)
        ...
        wasteProductDao                 = WasteProductDao(this,null)
    ...
    fun setMongoClientByTenantId(tenantId: String) {
        if (!tenantId.isNullOrEmpty()) {
            ...
            productStateDao?.dataStore              = temp
            ...
            wasteProductDao?.dataStore              = temp
        }
    }
